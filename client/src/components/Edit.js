                        ...
                        <div className="signup-form col-md-4">
                            <form method='POST' onSubmit={postData} className="register-form" id="register-form">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" required name='fname' id='fname' autoComplete='off' placeholder='Your first name' value={user.name} onChange={handleInputs} />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="username">
                                        <i className="zmdi zmdi-account material-icons-name"></i>
                                    </label>
                                    <input type="text" required name='username' id='username' autoComplete='off' placeholder='Enter user name' value={user.address} onChange={handleInputs} />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="email">
